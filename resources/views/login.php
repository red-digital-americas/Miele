        ...
        <div class="container login-wrapper">
            ...
            <form>
                <div id="login-container" class="login-container container col-xs-6 col-md-4">
                    <div class="col-md-12">
                        <div class="login-box-text"><center>Ingresar</center></div>
                    </div>
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            <label for="inputPassword" class="col-xs-5 col-sm-4 col-form-label">Contraseña</label>
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <center><button id="btnLogin" class="btn btn-md btn-primary">Entrar</button></center>
                            </div>
                        </div>
